        ...
        <div class="row">
            <div class="col-md-2 bg-primary text-white vh-100">
                ...
                <nav class="nav flex-column mt-4">
                    ...
                    <a class="nav-link text-white" href="#">Pregunta 1</a>
            ...
            <div class="col-md-10">
                ...
                <div class="d-flex justify-content-between align-items-center bg-light p-3">
                    ...
                    <div class="d-flex">
                        <a href="#" class="btn btn-outline-primary mx-1">Pregunta 1</a>
                        <a href="javascript:cargarOperaciones('operaciones.html')" class="btn btn-outline-primary mx-1">Pregunta 2</a>
                        <a href="javascript:cargarContenido3('pregunta3.php')" class="btn btn-outline-primary mx-1">Pregunta 3</a>
                        <a href="javascript:pregunta4('pregunta4.html')" class="btn btn-outline-primary mx-1">Pregunta 4</a>
                        <a href="javascript:cargarContenido5('pregunta5.html')" class="btn btn-outline-primary mx-1">Pregunta 5</a>
                    </div>
